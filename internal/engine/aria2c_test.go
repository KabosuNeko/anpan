...
func TestParseAriaProgressLine(t *testing.T) {
	...
	if res1.DownloadedBytes != 1258291 || res1.TotalBytes == nil || *res1.TotalBytes != 4718592 || res1.Connections != 16 || res1.Speed != 1153433 || res1.ETA == nil || *res1.ETA != 2 {
	...
	if res2.DownloadedBytes != 12582912 || res2.TotalBytes == nil || *res2.TotalBytes != 1503238553 || res2.Connections != 5 || res2.Seeders == nil || *res2.Seeders != 2 || res2.Speed != 1258291 || res2.ETA == nil || *res2.ETA != 300 {
	...
	if res3.DownloadedBytes != 0 || res3.TotalBytes == nil || *res3.TotalBytes != 1503238553 || res3.Connections != 5 || res3.Seeders == nil || *res3.Seeders != 0 || res3.Speed != 0 {
