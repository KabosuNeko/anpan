...
func FetchLyrics(ctx context.Context, title, artist string, duration float64) (*LyricsResult, error) {
	...
	if cleanArtist != "" && cleanTitle != "" {
		...
		if req != nil {
			req.Header.Set("User-Agent", "anpan-downloader/1.0.1 (https://github.com/KabosuNeko/anpan)")
	...
	sReq.Header.Set("User-Agent", "anpan-downloader/1.0.1 (https://github.com/KabosuNeko/anpan)")
